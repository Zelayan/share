.class public final Lsmartisanos/api/OneStepHelper2;
.super Ljava/lang/Object;


# static fields
.field public static mInstance:Lsmartisanos/api/OneStepHelper2;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lsmartisanos/api/OneStepHelper2;->mContext:Landroid/content/Context;

    return-void
.end method

.method public static declared-synchronized getInstance(Landroid/content/Context;)Lsmartisanos/api/OneStepHelper2;
    .locals 2

    const-class v0, Lsmartisanos/api/OneStepHelper2;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lsmartisanos/api/OneStepHelper2;->mInstance:Lsmartisanos/api/OneStepHelper2;

    if-nez v1, :cond_0

    new-instance v1, Lsmartisanos/api/OneStepHelper2;

    invoke-direct {v1, p0}, Lsmartisanos/api/OneStepHelper2;-><init>(Landroid/content/Context;)V

    sput-object v1, Lsmartisanos/api/OneStepHelper2;->mInstance:Lsmartisanos/api/OneStepHelper2;

    :cond_0
    sget-object p0, Lsmartisanos/api/OneStepHelper2;->mInstance:Lsmartisanos/api/OneStepHelper2;
    :try_end_0
...
.method public dragFile(Landroid/view/View;Ljava/io/File;Ljava/lang/String;Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
    ...
    iget-object v1, p0, Lsmartisanos/api/OneStepHelper2;->mContext:Landroid/content/Context;
...
.method public dragFile(Landroid/view/View;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lsmartisanos/api/OneStepHelper2;->mContext:Landroid/content/Context;
...
.method public dragImage(Landroid/view/View;Landroid/graphics/Bitmap;Ljava/io/File;Ljava/lang/String;)V
    ...
    iget-object p2, p0, Lsmartisanos/api/OneStepHelper2;->mContext:Landroid/content/Context;
