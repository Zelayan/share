.class public Lcom/sina/weibo/netcore/f/p;
...
.method public constructor <init>(Lcom/sina/weibo/netcore/f/d;)V
    ...
    iput-object p1, p0, Lcom/sina/weibo/netcore/f/p;->a:Lcom/sina/weibo/netcore/f/d;
...
.method private a(J)Lcom/sina/weibo/netcore/Utils/NetLogInfoCollect$NetLogInfo;
    ...
    iget-object v0, p0, Lcom/sina/weibo/netcore/f/p;->a:Lcom/sina/weibo/netcore/f/d;
...
.method public onFail(ILjava/lang/String;Lcom/sina/weibo/netcore/request/Request;)V
    ...
    const-string p1, "WeiboPushEngine"

    const-string p2, "HeartBeatMessage onFail"

    invoke-static {p1, p2}, Lcom/sina/weibo/netcore/Utils/NetLog;->i(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p1, p0, Lcom/sina/weibo/netcore/f/p;->a:Lcom/sina/weibo/netcore/f/d;

    invoke-static {p1}, Lcom/sina/weibo/netcore/f/d;->g(Lcom/sina/weibo/netcore/f/d;)Lcom/sina/weibo/netcore/WeiboNetCore;

    move-result-object p1

    invoke-virtual {p1}, Lcom/sina/weibo/netcore/WeiboNetCore;->getLongLinkStateCallBack()Lcom/sina/weibo/netcore/interfaces/LongLinkStateCallBack;
    ...
    invoke-interface {p1, p2, v0}, Lcom/sina/weibo/netcore/interfaces/LongLinkStateCallBack;->onLongLinkStateChanged(IZ)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/sina/weibo/netcore/f/p;->a(J)Lcom/sina/weibo/netcore/Utils/NetLogInfoCollect$NetLogInfo;

    move-result-object p1

    iget-object p2, p0, Lcom/sina/weibo/netcore/f/p;->a:Lcom/sina/weibo/netcore/f/d;
    ...
    iget-object p3, p0, Lcom/sina/weibo/netcore/f/p;->a:Lcom/sina/weibo/netcore/f/d;
...
.method public onSuccess(Lcom/sina/weibo/netcore/response/Response;)V
    ...
    const-string v1, "HeartBeatMessage onSuccess"
    ...
    invoke-interface {v0, v1, v2}, Lcom/sina/weibo/netcore/interfaces/LongLinkStateCallBack;->onLongLinkStateChanged(IZ)V
    ...
    invoke-direct {p0, v0, v1}, Lcom/sina/weibo/netcore/f/p;->a(J)Lcom/sina/weibo/netcore/Utils/NetLogInfoCollect$NetLogInfo;

    move-result-object v0

    iget-object v1, p0, Lcom/sina/weibo/netcore/f/p;->a:Lcom/sina/weibo/netcore/f/d;
    ...
    invoke-static {v0, v1, p1}, Lcom/sina/weibo/netcore/Utils/RecordLogUtil;->removeLog(JLandroid/content/Context;)V
